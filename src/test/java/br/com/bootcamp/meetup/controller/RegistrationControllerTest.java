...
//    @BeforeEach
//    void setUp() {
//        BDDMockito.when(registrationService.save(ArgumentMatchers.any())).thenReturn(RegistrationCreator.createRegistrationSaved());
//
//        BDDMockito.when(registrationService.findAllRegistration()).thenReturn();
//
//        BDDMockito.when(registrationService.findById(ArgumentMatchers.anyLong())).thenReturn(RegistrationCreator.createNewRegistrationValid());
//    }
//
//    @Test
